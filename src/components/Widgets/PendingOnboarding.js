...
const PendingOnboarding = ({ label, chartdata, labels, value }) => (
    <RctCard>
        <div className="rct-block-title d-flex justify-content-center" style={{cursor:'pointer',textAlign:'center'}}>
            <Link to='student/onboarding'>
                <div className="d-flex align-items-start">
                    <h4 style={{fontSize:'13px'}}><IntlMessages id="Pending Onboarding" /></h4>
                </div>
                <div className="align-items-end">
                    <span className="d-block text-muted counter-point"><CountUp start={0} end={localStorage.getItem("pending_onboard")} duration={3} useEasing={true} /></span>
