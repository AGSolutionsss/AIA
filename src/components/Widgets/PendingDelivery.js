...
const PendingDelivery = ({ label, chartdata, labels, value }) => (
    <RctCard>
        <div className="rct-block-title d-flex justify-content-center" style={{cursor:'pointer',textAlign:'center'}}>
            <Link to='delivery/listing'>
                <div className="d-flex align-items-start">
                    <h4><IntlMessages id="Pending Delivery" /></h4>
                </div>
                <div className="align-items-end">
                    <span className="d-block text-muted counter-point"><CountUp start={0} end={localStorage.getItem("pending_delivery")} duration={3} useEasing={true} /></span>
