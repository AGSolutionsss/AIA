...
const DeliveryReport = (props) => {
  ...
  useEffect(() => {
    ...
    axios({
      url: baseURL+"/fetch-delivery-report",
      method: "POST",
      data,
      headers: {
  ...
  return (
    <div>
      ...
      <div className="invoice-wrapper">
        <PageTitleBar title="Delivery List" match={props.match} />
        <div className="row">
                ...
                <div className="d-flex justify-content-between" style={{fontSize: '16px' }}>
                  ...
                  <div className="address text-center">
                    ...
                    <h2 style={{paddingTop: '5px'}}>
                      <strong>
                        <b style={{fontSize: '20px'}}>Delivery List</b>
                      </strong>
                    </h2>
                  </div>
                    ...
                    <Table aria-label="simple table" style={{border: '2px solid black', marginTop: '20px'}}>
                      <TableHead>          
                        <TableRow>
                          ...
                          <TableCell style={table_head}>Slip Shared</TableCell>
                          <TableCell style={table_head}>Delivery Mode</TableCell>
                      ...
                      <TableBody>
                        {teamsummary.map((dataSumm, key)=>(
                          <TableRow key={key}>
                            <TableCell style={table_row_count}>{Moment(dataSumm.delivery_date).format('DD-MM-YYYY')}</TableCell>
                            ...
                            <TableCell style={table_row_count}>{dataSumm.delivery_slip_shared}</TableCell>
                            <TableCell style={table_row_count}>{dataSumm.delivery_mode}</TableCell>
                            <TableCell style={table_row_count}>{dataSumm.delivery_status}</TableCell>
