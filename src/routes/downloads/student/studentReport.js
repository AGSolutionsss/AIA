...
const StudentReport = (props) => {
  ...
  useEffect(() => {
    ...
    axios({
      url: baseURL+"/fetch-student-report",
      method: "POST",
      data,
      headers: {
  ...
  return (
    <div>
      ...
      <div className="invoice-wrapper">
        <PageTitleBar title="Student List" match={props.match} />
        <div className="row">
                ...
                <div className="d-flex justify-content-between" style={{fontSize: '16px' }}>
                  ...
                  <div className="address text-center">
                    ...
                    <h2 style={{paddingTop: '5px'}}>
                      <strong>
                        <b style={{fontSize: '20px'}}>Student List</b>
                      </strong>
                    </h2>
                  </div>
                    ...
                    <Table aria-label="simple table" style={{border: '2px solid black', marginTop: '20px'}}>
                      <TableHead>          
                        <TableRow>
                          ...
                          <TableCell style={table_head}>Qualification</TableCell>
                          <TableCell style={table_head}>Admission No</TableCell>
                      ...
                      <TableBody>
                        {teamsummary.map((dataSumm, key)=>(
                          <TableRow key={key}>
                            ...
                            <TableCell style={table_row_count}>{dataSumm.qualification}</TableCell>
                            <TableCell style={table_row_count}>{dataSumm.admission_form_no}</TableCell>
                            <TableCell style={table_row_count}>{dataSumm.status}</TableCell>
