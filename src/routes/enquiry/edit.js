...
const EditPersonal = (props) => {
    ...
    const onSubmit = (e) => {
        ...
        axios({
            url: baseURL+"/panel-update-enquiry-personal/"+id,
            method: "PUT",
            data,
            headers: {
            Authorization: `Bearer ${localStorage.getItem("login")}`,
            ...
            if(res.data.code == '200'){
                ...
                history.push(`/app/enquiry/edit?id=${id}`);
            }else{
  ...
  return (
    <div className="textfields-wrapper">
      <PageTitleBar title="Edit Personal Details" match={props.match} />
      <RctCollapsibleCard>
        <form id="addIndiv" autoComplete="off">
          ...
          <div className="col-sm-12 col-md-12 col-xl-3">
            ...
            <div className="col-sm-12 col-md-12 col-xl-3">
              <div className="form-group">
                <label style={label}>New Followup Date</label><br/>
