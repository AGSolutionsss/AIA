...
export default class NewListStudentPendingInterview extends React.Component {
  state = {
    loader: true,
    users: [],
    studentData: [],
  ...
  getData = () => {
    let result = [];
    axios({
      url: baseURL+"/panel-fetch-student-pending-interview-list",
      method: "GET",
      headers: {
