...
export default class NewListStudentPendingOnboarding extends React.Component {
  state = {
    loader: true,
    users: [],
    studentData: [],
  ...
  getData = () => {
    let result = [];
    axios({
      url: baseURL+"/panel-fetch-student-pending-onboarding-list",
      method: "GET",
      headers: {
